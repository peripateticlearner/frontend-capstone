  ...
  return (
    <div style={{
      ...
      <p style={{ lineHeight: 1.6 }}>
        ...
        account signup and login, booking a ride, tracking ride status,
        and an admin dashboard for managing rides and registered users —
        backed by a REST API with JWT-based authentication.
      </p>
